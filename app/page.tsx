...
import { getCMSProperties, getCMSTestimonials, getCMSTeam, getCMSInstellingen, getCMSNieuwbouw } from "@/lib/cms";
...
const FALLBACK_TEAM = [
  ...
  { _id: "2", name: "Maxime Vanoppen", role: "Kantoorhouder & Vastgoedmakelaar", photoUrl: "https://somvastgoed.be/cms-assets/entities/people/ed7b76c1-50b1-45cb-a9b2-cabe0b1be386/photo?hash=0666424198239e93a486275c41b1276dbde95a281f12012abe86f3ad57b2e5db94d79c6a2da8f5ba6fa2ddcb5fbeae161a9569e973531389ce83457033ab80f9&v=C350x350" },
...
export default async function Home() {
  const [cmsProperties, cmsTeam, testimonials, settings, projects] = await Promise.all([
    getCMSProperties(),
    getCMSTeam(),
    getCMSTestimonials(),
    getCMSInstellingen(),
