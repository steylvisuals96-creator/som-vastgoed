...
export const property = defineType({
  ...
  fields: [
    ...
    defineField({ name: "landArea", title: "Perceel oppervlakte (m²)", type: "number" }),
    defineField({ name: "buildYear", title: "Bouwjaar", type: "number" }),
    defineField({ name: "condition", title: "Algemene staat", type: "string" }),
    defineField({ name: "bebouwing", title: "Bebouwing (Open/Halfopen/Gesloten)", type: "string" }),
    defineField({ name: "epc", title: "EPC waarde (kWh/m²/jaar)", type: "number" }),
    defineField({ name: "epcLabel", title: "EPC label (A/B/C/…)", type: "string" }),
